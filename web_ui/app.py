...
def get_stats_context(request: Request):
    ...
    return {
        ...
        "season_count": stats_blob.get("season_count"),
        "episode_count": stats_blob.get("episode_count"),
        "movie_cast_count": stats_blob.get("movie_cast_count"),
        "series_cast_count": stats_blob.get("series_cast_count"),
        "people_count": stats_blob.get("people_count"),
