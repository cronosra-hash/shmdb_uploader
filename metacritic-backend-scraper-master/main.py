...
if __name__ == "__main__":
	scraper = MetacriticScraper(product_type="movies") # product_type can be movies, games or shows
	...
	# products, reviews = scraper.fetch_product("Aliens")
	# products, reviews = scraper.fetch_product("Superman")
	# products, reviews = scraper.fetch_product("Batman Begins")
	products, reviews = scraper.fetch_product("28 Years Later")
